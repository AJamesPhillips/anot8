(function (redux) {
    ...
    ***************************************************************************** */
    ...
    function config_store() {
        ...
        var store = redux.createStore(root_reducer, starting_state);
        return store;
    }

    var store = config_store();
    ...
    var map_state = function (state) { return (__assign({}, state.routing)); };
    var connector = connect(map_state);
    function _App(props) {
        console.log("asd");
        return a("div", null,
            "Hello ",
            props.naming_authority);
    }
    var App = connector(_App);

    var root_element = document.getElementById("pages_container");
    N(a(App, null), root_element);
